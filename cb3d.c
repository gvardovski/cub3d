...
/*   Updated: 2025/10/21 20:14:48 by svolkau          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	start_game(t_cmlx *cb3d)
{
	...
	mlx_hook(cb3d->win, KeyPress, KeyPressMask, &handlevent, cb3d);
	mlx_loop_hook(cb3d->mlx, &redislpay, cb3d);
	mlx_loop(cb3d->mlx);
}
